...
- express.Router 함수(또는 객체)를 router라는 이름으로 사용하겠다
const router = express.Router

- express.Router() 함수를 실행하여 return 된 결과를 router 변수에 담아
const router = express.Router()
*/
const router = express.Router();
...
router.post("/", (req, res) => {
  ...
  // req.body에 담겨서 전달된 데이터를 INSERT 수행하라
...
router.get("/list", (req, res) => {
  ...
  // 결과를 result 변수에 받고
  // result 변수에 받은 데이터를 JSON type으로 client에게 보내라
